...
class RoutingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBalancerInfo = channel.unary_unary(
                '/v2ray.core.app.router.command.RoutingService/GetBalancerInfo',
        ...
        self.OverrideBalancerTarget = channel.unary_unary(
                '/v2ray.core.app.router.command.RoutingService/OverrideBalancerTarget',
...
def add_RoutingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'v2ray.core.app.router.command.RoutingService', rpc_method_handlers)
...
class RoutingService(object):
    ...
    def SubscribeRoutingStats(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/v2ray.core.app.router.command.RoutingService/SubscribeRoutingStats',
    ...
    def TestRoute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/v2ray.core.app.router.command.RoutingService/TestRoute',
    ...
    def GetBalancerInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/v2ray.core.app.router.command.RoutingService/GetBalancerInfo',
    ...
    def OverrideBalancerTarget(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/v2ray.core.app.router.command.RoutingService/OverrideBalancerTarget',
